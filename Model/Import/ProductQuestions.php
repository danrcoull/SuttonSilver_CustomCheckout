...
class ProductQuestions extends \Magento\ImportExport\Model\Import\Entity\AbstractEntity
{

    const QUESTION_ID = 'question_id';
    const QUESTION = 'question';
    const QUESTION_TYPE = 'question_type';
    const QUESTION_SKUS = 'product_skus';

    const QUESTION_TABLE_ENTITY = 'suttonsilver_question';
    const QUESTION_VALUES_TABLE_ENTITY = 'suttonsilver_questionvalues';
