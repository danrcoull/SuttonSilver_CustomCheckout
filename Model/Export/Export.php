        ...
        foreach($orders as $order)
        {
	        ...
	        if($order->getCustomerId()) {
				...
				if($customerObject) {
					...
					$customerArray['Homephone']    = ($attr = $customerObject->getCustomAttribute( 'daytime_phone_number' )) ? $attr->getValue() : "";
					$customerArray['Mobile']       = ($attr = $customerObject->getCustomAttribute( 'mobile_number' )) ? $attr->getValue() : "";
